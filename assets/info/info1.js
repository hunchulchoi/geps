const info1 = [
    ...
    {
        selected: ['청구', '10년이상', '정년퇴직', '퇴직연금일시금'],
        item1: ['1-9', '1-5'],
        item21: ['2-1-3'],
        item22: ['2-2-3', '2-2-4'],
    },
    {
        selected: ['청구', '10년이상', '명예퇴직', '퇴직연금'],
    ...
    {
        selected: ['청구', '10년이상', '명예퇴직', '퇴직연금일시금'],
        item1: ['1-9', '1-5'],
        item21: ['2-1-3', '2-1-6'],
        item22: ['2-2-4'],
    },
    {
        selected: ['청구', '10년이상', '일반퇴직', '퇴직연금'],
        item1: ['1-1', '1-2', '1-3', '1-4', '1-5', '1-6', '1-11'],
        item21: ['2-1-1', '2-1-2'],
        item22: ['2-2-1', '2-2-2', '2-2-3', '2-2-4'],
        item23: ['2-3-1', '2-3-2'],
    ...
    {
        selected: ['청구', '10년이상', '일반퇴직', '퇴직연금일시금'],
        item1: ['1-9', '1-5'],
        item21: ['2-1-3'],
        item22: ['2-2-3', '2-2-4'],
    },
...
<ul class="py-1 lead">
  <li class="pb-2">퇴직연금 중 일부기간을 일시금으로 받고 싶으신 경우 퇴직연금이 아닌 퇴직연금공제일시금을 선택하실 수 있습니다. 단, 연금선택기간은 10년 이상이어야 합니다</li>
</ul>
`,
...
<p>
    ...
    '1-13': `<ul class="py-2 lead">
<li class="pb-2">
    10년 미만 재직자는 퇴직일시금으로 급여청구할 수 있습니다.
    <ul>
        <li>기준소득월액은 최종기준소득월액으로 산정</li>
        <li>퇴직년도에 승진·전직·보직변경 등으로 봉급월액이 증가한 경우에는 봉급월액 증가분을 승진월수에 비례하여 기준소득월액에 가산</li>
        <li>퇴직일시금 산정액 보다 이미 낸 기여금+이자(5%)가 클 경우 퇴직일시금 산정액을 갈음하여 이미 낸 기여금+이자(5%) 금액을 지급함</li>
    </ul>
</li>
</ul>
<p>
...
const youtube = {
    ...
    '1-13': 'https://www.youtube.com/embed/JESKEKQLHfI',
