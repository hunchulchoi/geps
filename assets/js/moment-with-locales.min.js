!(function (e, a) {
    ...
    function fa(e, a) {
        ...
        if (((a.abbr = e), null != b[e]))
            ae('defineLocaleOverride', 'use moment.updateLocale(localeName, config) to change an existing locale. moment.defineLocale(localeName, config) should only be used for creating a new locale See http://momentjs.com/guides/#/warnings/define-locale/ for more info.'), (s = b[e]._config);
    ...
    function ka(e) {
        ...
        return (
            a &&
                -2 === h(e).overflow &&
                ((a = a[xe] < 0 || 11 < a[xe] ? xe : a[Pe] < 1 || a[Pe] > ze(a[g], a[xe]) ? Pe : a[w] < 0 || 24 < a[w] || (24 === a[w] && (0 !== a[Oe] || 0 !== a[We] || 0 !== a[Ae])) ? w : a[Oe] < 0 || 59 < a[Oe] ? Oe : a[We] < 0 || 59 < a[We] ? We : a[Ae] < 0 || 999 < a[Ae] ? Ae : -1),
        ...
        r
            ? ((a = xa(r[4], r[3], r[2], r[5], r[6], r[7])),
              ...
              t && sa.indexOf(t) !== new Date(s[0], s[1], s[2]).getDay()
                  ...
                  : ((e._a = a), (e._tzm = ((t = r[8]), (s = r[9]), (n = r[10]), t ? va[t] : s ? 0 : 60 * (((t = parseInt(n, 10)) - (s = t % 100)) / 100) + s)), (e._d = Ze.apply(null, e._a)), e._d.setUTCMinutes(e._d.getUTCMinutes() - e._tzm), (h(e).rfc2822 = !0)))
            : (e._isValid = !1);
    }
    function Oa(e, a, t) {
                ...
                s = e,
                    ...
                    e._w &&
                        ...
                        (null != (n = (s = e)._w).GG || null != n.W || null != n.E
                            ...
                            : ((_ = s._locale._week.dow), (o = s._locale._week.doy), (u = Xe(S(), _, o)), (r = Oa(n.gg, s._a[g], u.year)), (d = Oa(n.w, u.week)), null != n.d ? ((i = n.d) < 0 || 6 < i) && (m = !0) : null != n.e ? ((i = n.e + _), (n.e < 0 || 6 < n.e) && (m = !0)) : (i = _)),
    ...
    function Ea(e) {
        ...
        if (R(n)) e._d = n;
            ...
            R(r)
                ...
                : 'string' == typeof r
                ? ((t = n), null !== (a = Sa.exec(t._i)) ? (t._d = new Date(+a[1])) : (ja(t), !1 === t._isValid && (delete t._isValid, Pa(t), !1 === t._isValid && (delete t._isValid, t._strict ? (t._isValid = !1) : M.createFromInputFallback(t)))))
                : F(r)
    ...
    var x = Ja.prototype,
        Jt =
            ...
            (M.updateLocale = function (e, a) {
                ...
                return (
                    null != a
                        ? ((s = Ma), null != b[e] && null != b[e].parentLocale ? b[e].set(se(b[e]._config, a)) : ((a = se((s = null != (t = Ya(e)) ? t._config : s), a)), null == t && (a.abbr = e), ((s = new ne(a)).parentLocale = b[e]), (b[e] = s)), ya(e))
            ...
            (M.prototype = n),
            (M.HTML5_FMT = { DATETIME_LOCAL: 'YYYY-MM-DDTHH:mm', DATETIME_LOCAL_SECONDS: 'YYYY-MM-DDTHH:mm:ss', DATETIME_LOCAL_MS: 'YYYY-MM-DDTHH:mm:ss.SSS', DATE: 'YYYY-MM-DD', TIME: 'HH:mm', TIME_SECONDS: 'HH:mm:ss', TIME_MS: 'HH:mm:ss.SSS', WEEK: 'GGGG-[W]WW', MONTH: 'YYYY-MM' }),
            M.defineLocale('af', {
    ...
    M.defineLocale('az', {
        ...
        relativeTime: { future: '%s sonra', past: '%s \u0259vv\u0259l', s: 'bir ne\xe7\u0259 saniy\u0259', ss: '%d saniy\u0259', m: 'bir d\u0259qiq\u0259', mm: '%d d\u0259qiq\u0259', h: 'bir saat', hh: '%d saat', d: 'bir g\xfcn', dd: '%d g\xfcn', M: 'bir ay', MM: '%d ay', y: 'bir il', yy: '%d il' },
    ...
    M.defineLocale('br', {
        ...
        M.defineLocale('ca', {
            ...
            relativeTime: { future: "d'aqu\xed %s", past: 'fa %s', s: 'uns segons', ss: '%d segons', m: 'un minut', mm: '%d minuts', h: 'una hora', hh: '%d hores', d: 'un dia', dd: '%d dies', M: 'un mes', MM: '%d mesos', y: 'un any', yy: '%d anys' },
    ...
    M.defineLocale('cs', {
        ...
        M.defineLocale('cy', {
            ...
            relativeTime: { future: 'mewn %s', past: '%s yn \xf4l', s: 'ychydig eiliadau', ss: '%d eiliad', m: 'munud', mm: '%d munud', h: 'awr', hh: '%d awr', d: 'diwrnod', dd: '%d diwrnod', M: 'mis', MM: '%d mis', y: 'blwyddyn', yy: '%d flynedd' },
        ...
        M.defineLocale('da', {
            ...
            relativeTime: { future: 'om %s', past: '%s siden', s: 'f\xe5 sekunder', ss: '%d sekunder', m: 'et minut', mm: '%d minutter', h: 'en time', hh: '%d timer', d: 'en dag', dd: '%d dage', M: 'en m\xe5ned', MM: '%d m\xe5neder', y: 'et \xe5r', yy: '%d \xe5r' },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: '%d.',
            week: { dow: 1, doy: 4 },
        }),
    ...
    M.defineLocale('es', {
        ...
        relativeTime: { future: 'en %s', past: 'hace %s', s: 'unos segundos', ss: '%d segundos', m: 'un minuto', mm: '%d minutos', h: 'una hora', hh: '%d horas', d: 'un d\xeda', dd: '%d d\xedas', w: 'una semana', ww: '%d semanas', M: 'un mes', MM: '%d meses', y: 'un a\xf1o', yy: '%d a\xf1os' },
        dayOfMonthOrdinalParse: /\d{1,2}\xba/,
        ordinal: '%d\xba',
        week: { dow: 1, doy: 4 },
        invalidDate: 'Fecha inv\xe1lida',
    ...
    M.defineLocale('fi', {
        ...
        M.defineLocale('fo', {
            ...
            relativeTime: { future: 'um %s', past: '%s s\xed\xf0ani', s: 'f\xe1 sekund', ss: '%d sekundir', m: 'ein minuttur', mm: '%d minuttir', h: 'ein t\xedmi', hh: '%d t\xedmar', d: 'ein dagur', dd: '%d dagar', M: 'ein m\xe1na\xf0ur', MM: '%d m\xe1na\xf0ir', y: 'eitt \xe1r', yy: '%d \xe1r' },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: '%d.',
            week: { dow: 1, doy: 4 },
        }),
    ...
    M.defineLocale('fy', {
        ...
        relativeTime: { future: 'oer %s', past: '%s lyn', s: 'in pear sekonden', ss: '%d sekonden', m: 'ien min\xfat', mm: '%d minuten', h: 'ien oere', hh: '%d oeren', d: 'ien dei', dd: '%d dagen', M: 'ien moanne', MM: '%d moannen', y: 'ien jier', yy: '%d jierren' },
        dayOfMonthOrdinalParse: /\d{1,2}(ste|de)/,
        ordinal: function (e) {
            return e + (1 === e || 8 === e || 20 <= e ? 'ste' : 'de');
        },
        ...
        M.defineLocale('ga', {
            ...
            relativeTime: { future: 'i %s', past: '%s \xf3 shin', s: 'c\xfapla soicind', ss: '%d soicind', m: 'n\xf3im\xe9ad', mm: '%d n\xf3im\xe9ad', h: 'uair an chloig', hh: '%d uair an chloig', d: 'l\xe1', dd: '%d l\xe1', M: 'm\xed', MM: '%d m\xedonna', y: 'bliain', yy: '%d bliain' },
    ...
    M.defineLocale('gd', {
        ...
        relativeTime: { future: 'ann an %s', past: 'bho chionn %s', s: 'beagan diogan', ss: '%d diogan', m: 'mionaid', mm: '%d mionaidean', h: 'uair', hh: '%d uairean', d: 'latha', dd: '%d latha', M: 'm\xecos', MM: '%d m\xecosan', y: 'bliadhna', yy: '%d bliadhna' },
        dayOfMonthOrdinalParse: /\d{1,2}(d|na|mh)/,
        ordinal: function (e) {
            return e + (1 === e ? 'd' : e % 10 == 2 ? 'na' : 'mh');
        },
    ...
    M.defineLocale('me', {
        ...
        relativeTime: { future: 'za %s', past: 'prije %s', s: 'nekoliko sekundi', ss: en.translate, m: en.translate, mm: en.translate, h: en.translate, hh: en.translate, d: 'dan', dd: en.translate, M: 'mjesec', MM: en.translate, y: 'godinu', yy: en.translate },
        dayOfMonthOrdinalParse: /\d{1,2}\./,
        ordinal: '%d.',
        week: { dow: 1, doy: 7 },
    }),
    ...
    var rn = { 1: '\u1041', 2: '\u1042', 3: '\u1043', 4: '\u1044', 5: '\u1045', 6: '\u1046', 7: '\u1047', 8: '\u1048', 9: '\u1049', 0: '\u1040' },
        ...
        hn =
            ...
            M.defineLocale('oc-lnc', {
                ...
                relativeTime: { future: "d'aqu\xed %s", past: 'fa %s', s: 'unas segondas', ss: '%d segondas', m: 'una minuta', mm: '%d minutas', h: 'una ora', hh: '%d oras', d: 'un jorn', dd: '%d jorns', M: 'un mes', MM: '%d meses', y: 'un an', yy: '%d ans' },
                dayOfMonthOrdinalParse: /\d{1,2}(r|n|t|\xe8|a)/,
                ordinal: function (e, a) {
                    return e + ('w' !== a && 'W' !== a ? (1 === e ? 'r' : 2 === e ? 'n' : 3 === e ? 'r' : 4 === e ? 't' : '\xe8') : 'a');
                },
    ...
    M.defineLocale('pl', {
        ...
        M.defineLocale('pt-br', {
            ...
            relativeTime: { future: 'em %s', past: 'h\xe1 %s', s: 'poucos segundos', ss: '%d segundos', m: 'um minuto', mm: '%d minutos', h: 'uma hora', hh: '%d horas', d: 'um dia', dd: '%d dias', M: 'um m\xeas', MM: '%d meses', y: 'um ano', yy: '%d anos' },
            dayOfMonthOrdinalParse: /\d{1,2}\xba/,
            ordinal: '%d\xba',
        ...
        M.defineLocale('pt', {
            ...
            relativeTime: { future: 'em %s', past: 'h\xe1 %s', s: 'segundos', ss: '%d segundos', m: 'um minuto', mm: '%d minutos', h: 'uma hora', hh: '%d horas', d: 'um dia', dd: '%d dias', w: 'uma semana', ww: '%d semanas', M: 'um m\xeas', MM: '%d meses', y: 'um ano', yy: '%d anos' },
            dayOfMonthOrdinalParse: /\d{1,2}\xba/,
            ordinal: '%d\xba',
            week: { dow: 1, doy: 4 },
        }),
        M.defineLocale('ro', {
            ...
            relativeTime: { future: 'peste %s', past: '%s \xeen urm\u0103', s: 'c\xe2teva secunde', ss: pn, m: 'un minut', mm: pn, h: 'o or\u0103', hh: pn, d: 'o zi', dd: pn, w: 'o s\u0103pt\u0103m\xe2n\u0103', ww: pn, M: 'o lun\u0103', MM: pn, y: 'un an', yy: pn },
            week: { dow: 1, doy: 7 },
        });
    (y = [
        /^\u044f\u043d\u0432/i,
    ...
    M.defineLocale('sk', {
        ...
        M.defineLocale('sq', {
            ...
            relativeTime: { future: 'n\xeb %s', past: '%s m\xeb par\xeb', s: 'disa sekonda', ss: '%d sekonda', m: 'nj\xeb minut\xeb', mm: '%d minuta', h: 'nj\xeb or\xeb', hh: '%d or\xeb', d: 'nj\xeb dit\xeb', dd: '%d dit\xeb', M: 'nj\xeb muaj', MM: '%d muaj', y: 'nj\xeb vit', yy: '%d vite' },
            dayOfMonthOrdinalParse: /\d{1,2}\./,
            ordinal: '%d.',
            week: { dow: 1, doy: 4 },
        });
    var W = {
        ...
        wn =
            (M.defineLocale('sr', {
                ...
                relativeTime: { future: 'za %s', past: 'pre %s', s: 'nekoliko sekundi', ss: A.translate, m: A.translate, mm: A.translate, h: A.translate, hh: A.translate, d: A.translate, dd: A.translate, M: A.translate, MM: A.translate, y: A.translate, yy: A.translate },
                dayOfMonthOrdinalParse: /\d{1,2}\./,
                ordinal: '%d.',
                week: { dow: 1, doy: 7 },
            }),
            ...
            M.defineLocale('sv', {
                ...
                relativeTime: { future: 'om %s', past: 'f\xf6r %s sedan', s: 'n\xe5gra sekunder', ss: '%d sekunder', m: 'en minut', mm: '%d minuter', h: 'en timme', hh: '%d timmar', d: 'en dag', dd: '%d dagar', M: 'en m\xe5nad', MM: '%d m\xe5nader', y: 'ett \xe5r', yy: '%d \xe5r' },
    ...
    var xn = { 1: "'inci", 5: "'inci", 8: "'inci", 70: "'inci", 80: "'inci", 2: "'nci", 7: "'nci", 20: "'nci", 50: "'nci", 3: "'\xfcnc\xfc", 4: "'\xfcnc\xfc", 100: "'\xfcnc\xfc", 6: "'nc\u0131", 9: "'uncu", 10: "'uncu", 30: "'uncu", 60: "'\u0131nc\u0131", 90: "'\u0131nc\u0131" };
    function Pn(e, a, t, s) {
        e = {
    ...
    return (
        ...
        M.defineLocale('vi', {
            ...
            calendar: { sameDay: '[H\xf4m nay l\xfac] LT', nextDay: '[Ng\xe0y mai l\xfac] LT', nextWeek: 'dddd [tu\u1ea7n t\u1edbi l\xfac] LT', lastDay: '[H\xf4m qua l\xfac] LT', lastWeek: 'dddd [tu\u1ea7n tr\u01b0\u1edbc l\xfac] LT', sameElse: 'L' },
            relativeTime: {
                future: '%s t\u1edbi',
                past: '%s tr\u01b0\u1edbc',
                s: 'v\xe0i gi\xe2y',
